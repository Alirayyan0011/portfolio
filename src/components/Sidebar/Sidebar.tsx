    ...
    <>
      ...
      {isMobile && (
        <button
          ...
          className="fixed top-4 left-4 z-50 p-2 rounded-md bg-[#0a4b5c] text-[#e0f7fa] lg:hidden"
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 h-full bg-[#0a4b5c] text-[#e0f7fa] z-40 transition-all duration-300 ${
      ...
      >
        <div className="h-full flex flex-col overflow-y-auto">
          ...
          <nav className="flex-1 px-4 py-6">
            <ul className="space-y-2">
              <li>
                <Link
                  href="/"
                  className="flex items-center px-4 py-3 rounded-lg text-[#e0f7fa] hover:bg-[#0a4b5c]/80 hover:text-[#a8e6cf] transition-colors duration-300"
          ...
          {/* Social Links / Footer */}
          <div className="p-6 border-t border-[#e0f7fa]/20">
            ...
            <p className="text-xs text-center text-[#b2ebf2]">
